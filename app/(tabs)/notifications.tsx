...
/**
 * In-app notification list from GET /notifications.
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.canvas }} edges={["top"]}>
      <ScrollView className="gg-screen">
        ...
        <Text className="text-body text-text-secondary">
          SLA deadlines and order state changes for your account.
        </Text>
        ...
        {!items.length && !loading && !error ? (
          <EmptyState
            ...
            body="Updates about your print jobs will show up here."
          />
        ) : null}
        </View>
      </ScrollView>
