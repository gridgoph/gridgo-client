...
/**
 * Browser file pick. Expo's native-module probe is empty on web, so the
 * library and document pickers refuse with "needs a rebuilt GRIDGO app"
 * even though a hidden `<input type="file">` works in the browser.
 */
