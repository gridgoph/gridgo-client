 ...
 * same file.
 */
describe("Sign In after an attempt that failed", () => {
  it("comes back tappable rather than eating the next tap", async () => {
    mockPassword.mockRejectedValue(new Error("Wrong password"));
    ...
    // The handler's `finally` lowered it. Without one, a single wrong password
